...
## Описание
* Проект предоставляет три основных скрипта для работы с Grafana API:
...
* Текстовое Меню - для удобной настройки env и активации скриптов для бекапа и восстановления.
